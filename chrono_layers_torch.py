...
class LayerSumSimple(nn.Module):
  def __init__(self, functions, cumoplus=cummax, odot=operator.add, pad_with=None, return_all=False, take_diff=False, **kwargs):
...
def test_layer_sum_simple():
    ...
    x = flip( torch.tensor([[[0,2,5,3,8,1,7],
                             [0,3,2,1,8,1,7]]]) )
    #print('x=',x,x.shape)
